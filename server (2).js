...
app.post('/api/signup/start', async (req, res) => {
  try {
    ...
    const { email, passcode, accountName, page } = req.body || {};
    ...
    const session = await stripe.checkout.sessions.create({
      ...
      // conversion to the same landing page that started it.
      metadata: { classId: String(created.id), planId: process.env.STRIPE_PRICE_ID, sourcePage },
